...
/**
 * Class for obtaining geolocation information about an IP address. The class uses the
 * <a href="http://ip-api.com">IP-API.com</a> service
 */
public class GeoLocator {
     ...
     * If the argument is null <code>null</code>, the method returns geolocation information about
